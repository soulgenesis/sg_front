<div class="grid grid-cols-12 mt-28">
	<h2 class="subheading pl-4 col-span-full sm:col-start-6 sm:pl-0">How it works?</h2>
	<p class="mt-9 col-span-full pl-4 para sm:col-start-6 sm:pl-0">
		We used the opportunity provided<br/> by the blockchain technology standard<br /> to change the JPEGs that
		are attached<br/> to the token.<br> It is available to everyone but hardly ever used.
	</p>
</div>
